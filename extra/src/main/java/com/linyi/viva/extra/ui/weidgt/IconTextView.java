...
//    private final boolean lineContainPadding = false;
    ...
    private final int mTextAlignType =  ALIGN_VIEW;     //线条对其类型
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        LINE_WIDTH = (int) getResources().getDimension(R.dimen.line_size);
        LINE_COLOR = UIUtils.getColor(R.color.line_color);
        mPaint = new Paint();
