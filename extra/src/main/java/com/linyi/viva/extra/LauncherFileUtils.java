...
public class LauncherFileUtils {
    ...
    /**
     * 1. 将图片存放在 main/assets/ 目录下（需要文件读写权限）,命名launcher.png
     * 2. pc上创建D:\launcher\文件夹
     * 3. 导出到pc上 输出命令： adb pull /sdcard/launcherDir/ D:\launcher\
     */
    ...
    private static Bitmap getImageFromAssetsFile(String fileName) {
        Bitmap image = null;
        AssetManager am = VivaSdk.getContext().getResources().getAssets();
        try {
