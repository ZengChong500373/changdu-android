...
//						Toast.LENGTH_LONG).show();
	...
	public void collectDeviceInfo() {
		try {
			PackageManager pm = VivaSdk.getContext().getPackageManager();
			PackageInfo pi = pm.getPackageInfo(VivaSdk.getContext().getPackageName(),
...
//						+ "/crashinfo/";
				String path= VivaSdk.getContext().getExternalFilesDir(null).getAbsolutePath()+ "/crashinfo/";
				//创建文件夹和文件
