...
public class LogUtil {
    ...
    public static boolean isDebug = VivaConstant.showLog;
    //是否采用原生精简打印
    private static final boolean isSimpleFormat = false;
