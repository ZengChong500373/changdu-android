...
public class DeviceInfoUtil {
    ...
    public String getUUID(Context context){
        ...
        if (TextUtils.isEmpty(uuid)) {
            uuid = SharePreUtil.getString(UNIQUE_CODE_KEY);
            flag = "cache uuid = ";
            if (TextUtils.isEmpty(uuid)) {
                ...
                SharePreUtil.putString(UNIQUE_CODE_KEY, uuid);
            }
    ...
    private String newUniqueCode() {
        String value = SharePreUtil.getString(RANDOM_CODE_KEY);
        if (TextUtils.isEmpty(value)) {
            value = System.currentTimeMillis() + VivaConstant.PackageName;
            SharePreUtil.putString(RANDOM_CODE_KEY, value);
        }
        return value;
    }
